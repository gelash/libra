...
sourcesIndex["libra_logger"] = {"name":"","files":["lib.rs","security.rs","struct_log.rs","text_log.rs"]};
sourcesIndex["libra_management"] = {"name":"","files":["config_builder.rs","error.rs","genesis.rs","json_rpc.rs","key.rs","layout.rs","lib.rs","secure_backend.rs","storage_helper.rs","validator_config.rs","verify.rs","waypoint.rs"]};
...
sourcesIndex["network"] = {"name":"","dirs":[{"name":"connectivity_manager","files":["builder.rs","mod.rs"]},{"name":"interface","files":["mod.rs"]},{"name":"noise","files":["fuzzing.rs","handshake.rs","mod.rs","stream.rs"]},{"name":"peer","files":["mod.rs"]},{"name":"peer_manager","files":["builder.rs","conn_notifs_channel.rs","error.rs","mod.rs"]},{"name":"protocols","dirs":[{"name":"direct_send","files":["mod.rs"]},{"name":"discovery","files":["builder.rs","mod.rs"]},{"name":"health_checker","files":["builder.rs","mod.rs"]},{"name":"network","files":["mod.rs"]},{"name":"rpc","files":["error.rs","fuzzing.rs","mod.rs"]},{"name":"wire","dirs":[{"name":"handshake","dirs":[{"name":"v1","files":["mod.rs"]}]},{"name":"messaging","dirs":[{"name":"v1","files":["mod.rs"]}]}],"files":["handshake.rs","messaging.rs","mod.rs"]}],"files":["identity.rs","mod.rs"]},{"name":"sink","files":["buffered_send.rs","mod.rs"]},{"name":"testutils","files":["fake_socket.rs","mod.rs"]}],"files":["common.rs","constants.rs","counters.rs","error.rs","lib.rs","logging.rs","transport.rs"]};
...
sourcesIndex["transaction_builder_generator"] = {"name":"","files":["common.rs","cpp.rs","lib.rs","python3.rs","rust.rs"]};
