...
impl NativeFunction {
    pub(crate) fn resolve(
        ...
        Some(match case {
            ...
            (&CORE_CODE_ADDRESS, "Vector", "initialize") => VectorInitialize,
            ...
            (&CORE_CODE_ADDRESS, "Vector", "clear") => VectorClear,
    ...
    pub(crate) fn dispatch(
        ...
        let result = match self {
            ...
            Self::VectorInitialize => vector::native_initialize(ctx, t, v),
            ...
            Self::VectorClear => vector::native_clear(ctx, t, v),
